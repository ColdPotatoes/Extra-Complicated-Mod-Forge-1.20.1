package net.ryannoh.extracomplicatedmod;
...
@Mod(ExtraComplicatedMod.MOD_ID)
public class ExtraComplicatedMod {
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "extracomplicatedmod";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();

    public ExtraComplicatedMod(FMLJavaModLoadingContext context) {
